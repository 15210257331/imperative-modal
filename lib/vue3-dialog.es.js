...
const de = (e) => (U("data-v-36b5147c"), e = e(), V(), e), pe = ["id"], fe = { class: "dialog-header" }, ve = { class: "title" }, ge = /* @__PURE__ */ de(() => /* @__PURE__ */ g("svg", {
  t: "1679295681396",
  class: "icon",
...
const he = (e, o) => {
  ...
  for (const [u, r] of o)
    t[u] = r;
  return t;
}, we = /* @__PURE__ */ he(ye, [["__scopeId", "data-v-36b5147c"]]);
function Oe() {
  let e = 0;
