...
const fe = (e) => (V("data-v-5905c1ce"), e = e(), z(), e), ve = ["id"], ge = { class: "dialog-header" }, me = { class: "title" }, _e = /* @__PURE__ */ fe(() => /* @__PURE__ */ g("svg", {
  t: "1679295681396",
  class: "icon",
...
const Oe = (e, t) => {
  ...
  for (const [i, r] of t)
    o[i] = r;
  return o;
}, Ie = /* @__PURE__ */ Oe(we, [["__scopeId", "data-v-5905c1ce"]]);
function be() {
  let e = 0, t = null;
